...
import io.github.im10furry.gb32960.auth.provider.ConnectionRateLimitProvider;
import io.github.im10furry.gb32960.auth.provider.NoopAuthProvider;
import io.github.im10furry.gb32960.auth.provider.VinWhitelistAuthProvider;
...
import io.github.im10furry.gb32960.core.crypto.AesCryptoProvider;
import io.github.im10furry.gb32960.core.crypto.CryptoProvider;
import io.github.im10furry.gb32960.core.crypto.NoopCryptoProvider;
import io.github.im10furry.gb32960.starter.properties.Gb32960Properties;
import io.github.im10furry.gb32960.transport.server.Gb32960Server;
...
public class Gb32960AutoConfiguration {
    ...
    public OutputAdapter kafkaAdapter(Gb32960Properties props,
        ...
        return new io.github.im10furry.gb32960.output.kafka.KafkaOutputAdapter(
    ...
    public OutputAdapter rocketMQAdapter(Gb32960Properties props,
        ...
        return new io.github.im10furry.gb32960.output.rocketmq.RocketMQOutputAdapter(
    ...
    public OutputAdapter rabbitMQAdapter(Gb32960Properties props,
        ...
        return new io.github.im10furry.gb32960.output.rabbitmq.RabbitMQOutputAdapter(
                rabbitTemplate,
    ...
    public OutputAdapter redisStreamAdapter(Gb32960Properties props,
        ...
        return new io.github.im10furry.gb32960.output.redis.RedisStreamOutputAdapter(
    ...
    public OutputAdapter mqttAdapter(Gb32960Properties props) {
        try {
            return new io.github.im10furry.gb32960.output.mqtt.MqttOutputAdapter(
